...
function FoodHero(props) {
    return (
        <div className="food-hero">
            <img src={props.image} alt={props.name} id="food-image" />
            <div className="food-title">
                <h1 className="food-name text-title">{props.name}</h1>
                <a href={props.videolink} className="food-link">
