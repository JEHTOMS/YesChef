...
function Menu(){
    ...
    const { session, displayName, credits, isPro, subscriptionTier, loading } = useUser();
    ...
    return(
        <div className="page">
            ...
            onCloseRightClick={() => navigate(location.state?.from || '/')}
            />
...
<div className="profile-details">{loading ? '' : (displayName || 'Profile')} {!loading && userEmail && <p className="text-sm" style={{color: "#737373"}}>{userEmail}</p>}</div></div><svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1 11L6 6L1 1" stroke="#757575" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
</Link>
                        </li>
                        <li className="menu-item">
                            <Link to="/saved-recipes" id="savedRecipes" className="menu-link text-lg">
...
<path d="M1 11L6 6L1 1" stroke="#757575" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <li className="menu-item">
                            <Link to="/plans" state={{ from: '/menu', origin: location.state?.from || '/' }} id="plans" className="menu-link text-lg">
                            <div className="menu-tag"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>Plans</div><div className="subtag-wrapper"><div className="subtag text-sm">{subscriptionTier === 'lifetime' ? 'Lifetime' : isPro ? 'Pro' : <><span id="credit-left">{credits ?? '...'} </span>cr. left</>}</div><svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1 11L6 6L1 1" stroke="#757575" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg></div>
</Link>
                        </li>
                        <li className={`menu-item${!isPro ? ' menu-item-disabled' : ''}`}>
                            <Link to="/speech" id="speech" className="menu-link text-lg" onClick={!isPro ? (e) => e.preventDefault() : undefined}>
                            <div className="menu-tag"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>Speech</div><div className="subtag-wrapper">{!isPro && <button className="subtag-upgrade text-sm" onClick={(e) => { e.preventDefault(); e.stopPropagation(); navigate('/plans', { state: { from: '/menu', origin: location.state?.from || '/' } }); }}>Upgrade to pro</button>}<svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1 11L6 6L1 1" stroke="#757575" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg></div>
</Link>
                        </li>
                ...
                <div className="menu-container">
                    <ul className="list">
                        <li className="menu-item">
                            <a href="mailto:hello@yescheff.co" id="support" className="menu-link text-lg">
                            <div className="menu-tag"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M1 11L6 6L1 1" stroke="#757575" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <li className="menu-item">
                            <Link to="/terms-of-service" id="terms-of-service" className="menu-link text-lg">
                            <div className="menu-tag"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M1 11L6 6L1 1" stroke="#757575" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <li className="menu-item">
                            <button onClick={handleSignOut} id="sign-out" className="menu-link text-lg" style={{border: "none", width: "100%", cursor: "pointer"}}>
                            <div className="menu-tag"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M1 11L6 6L1 1" stroke="#757575" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <p className="app-version text-sm">Version 2.0.0</p>
            </div>
            </div>
        </div>
    );
